...
//     (req.body.userName) ? ((regExpUserName.test(req.body.userName)) ? "" : dataErr.validUserNameErr = "Enter a valid username") : "";
//     (req.body.firstName) ? ((regExpName.test(req.body.firstName)) ? "" : dataErr.validFirstNameErr = "Enter a valid firstName") : "";
//     (req.body.lastName) ? ((regExpLast.test(req.body.lastName)) ? "" : dataErr.validLastNameErr = "Enter a valid lastname") : "";
